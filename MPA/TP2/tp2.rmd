...
```{r}
res1Gauche <- algorithme_gibbs(seq1[1:(point_estime-1)], n_iteration = 5000, n_elimine = 1000,
                         c_initial = 1, theta1_initial = 0.2, theta2_initial = 0.8)

barplot(res1Gauche$p_c, main = "Distribution de p(c|y) - Partie Gauche de la chaine avant le point estimé", col = "red", xlab = "position c", ylab = "p(c|y)" )
```
...
```{r}
res1Droite <- algorithme_gibbs(seq1[(point_estime+1):length(seq1)], n_iteration = 5000, n_elimine = 1000,
                         c_initial = 1, theta1_initial = 0.2, theta2_initial = 0.8)

barplot(res1Droite$p_c, main = "Distribution de p(c|y) - Partie Droite de la chaine avant le point estimé", col = "red", xlab = "position c", ylab = "p(c|y)" )
```
...
```
On a un mode en c = 54, donc un autre point de changement. Cela correspond à la position 56 (point ou on a découpé) + c_droite = 110
