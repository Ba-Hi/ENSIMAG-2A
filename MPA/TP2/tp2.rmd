...
\end{aligned}
$$
Prenons la loi a priori non informative Unif(0,1) = Beta(1,1) : $\theta_1 \sim \mathcal{Beta}(1, 1)$
...
$$
\boxed{
\theta_1 \mid y, c^{(t)} \sim  \mathcal{Beta}(s_1 + 1, m_1 - s_1 + 1)
}
$$
...
$$
\boxed{
\theta_2 \mid y, c^{(t)} \sim  \mathcal{Beta}(s_2 + 1, m_2 - s_2 + 1)
}
$$
